...
<head>
    ...
    <title>Register - PT. DWI WIRA USAHA BAKTI</title>
...
<body>
    <div class="auth-container">
        <h2>Register</h2>
        <form method="POST" action="/register"> {{-- Ganti dengan route register Anda --}}
            @csrf
            ...
            <p class="text-muted">Sudah punya akun? <a href="/login">Login di sini</a></p>
        </form>
    </div>
